    ...
    methods: {
        ...
        onCalculateJournal() {
            ...
            if (debit > credit) {
                ...
                this.total.credit_formatted = credit - debit;

                if (this.total.debit != debit) {
                    this.total.debit = debit;
                    this.total.debit_formatted = debit;
                }
                ...
                this.total.debit_formatted = debit - credit;
                
                if (this.total.credit != credit) {
                    this.total.credit = credit;
                    this.total.credit_formatted = credit;
                }
            ...
            if (this.sub.debit != debit) {
                this.sub.debit_formatted = debit;
                this.sub.debit = debit;
            }

            if (this.sub.credit != credit) {
                this.sub.credit_formatted = credit;
